"""
Django settings for universityregister project.
...
import dj_database_url #migration to postgresql in supabase
...
ROOT_URLCONF = 'universityregister.urls'
...
WSGI_APPLICATION = "universityregister.wsgi.application"
